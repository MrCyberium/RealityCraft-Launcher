...
function showUpdateUI(info){
    ...
    document.getElementById('image_seal_container').onclick = () => {
        setOverlayContent('Mise à jour disponible', 'Une nouvelle mise à jour pour le launcher est disponible. Souhaitez-vous l\'installer maintenant ?', 'Installer', 'Plus tard')
        setOverlayHandler(() => {
            if(!isDev){
                ipcRenderer.send('autoUpdateAction', 'installUpdateNow')
            } else {
