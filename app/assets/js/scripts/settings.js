            ...
            <div class="settingsAuthAccountRight">
                <div class="settingsAuthAccountDetails">
                    <div class="settingsAuthAccountDetailPane">
                        <div class="settingsAuthAccountDetailTitle">Pseudo Minecraft</div>
                ...
                <div class="settingsAuthAccountActions">
                    <button class="settingsAuthAccountSelect" ${selectedUUID === acc.uuid ? 'selected>Compte actif &#10004;' : '>Select Account'}</button>
...
function populateReleaseNotes(){
    $.ajax({
        url: 'https://github.com/MrCyberium/RealityCraft-Launcher/releases.atom',
        success: (data) => {
